...
test_that("no generic",{
  ...
  expect_equal(printer(R62S4_NoGeneric$new(), "Hello World"), "Hello World")
  expect_error(excluder(R62S4_NoGeneric$new()))
  expect_equal(Status(R62S4_NoGeneric$new()), "Printing")
...
test_that("S4 generic",{
  ...
  expect_equal(upper(R62S4_S4Generic$new(), "hello world"), "HELLO WORLD")
  expect_error(excluder(R62S4_S4Generic$new()))
  expect_equal(Status(R62S4_S4Generic$new()), "Printing")
