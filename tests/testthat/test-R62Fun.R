...
test_that("mask TRUE",{
  expect_silent(R62Fun(varMask, assignEnvir = parent.env(environment()), mask = T))
...
test_that("mask FALSE",{
  expect_silent(R62Fun(covMask, assignEnvir = parent.env(environment())))
...
test_that("Gen FALSE mask TRUE",{
  expect_silent(R62Fun(noGenMask, assignEnvir = parent.env(environment()),
